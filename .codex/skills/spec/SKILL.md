...
1. Spec group must exist at `.codex/specs/groups/<spec-group-id>/`
...
```
.codex/specs/groups/<spec-group-id>/spec.md
```
...
**Location**: .codex/specs/groups/<spec-group-id>/spec.md
...
1. Review spec: `.codex/specs/groups/<spec-group-id>/spec.md`
...
```bash
cp .codex/templates/master-spec.template.md .codex/specs/groups/<spec-group-id>/spec.md
```
...
Follow the WorkstreamSpec template at .codex/templates/workstream-spec.template.md`,
...
See `.codex/templates/workstream-spec.template.md` for full structure.
