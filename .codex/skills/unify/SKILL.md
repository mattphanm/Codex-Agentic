...
# Load requirements
cat .codex/specs/groups/<spec-group-id>/requirements.md
...
```bash
# Read atomic spec
cat .codex/specs/groups/<spec-group-id>/atomic/as-001-logout-button-ui.md
```
...
grep -A 10 "contracts" .codex/specs/groups/<spec-group-id>/manifest.json
```
