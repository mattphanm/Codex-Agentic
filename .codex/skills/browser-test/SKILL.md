...
user-invocable: true
allowed-tools: Read, mcp__codex-in-chrome__tabs_context_mcp, mcp__codex-in-chrome__tabs_create_mcp, mcp__codex-in-chrome__navigate, mcp__codex-in-chrome__read_page, mcp__codex-in-chrome__find, mcp__codex-in-chrome__computer, mcp__codex-in-chrome__form_input, mcp__codex-in-chrome__javascript_tool
---
...
Execute browser-based UI testing for web applications using Codex in Chrome MCP tools. Verify UI acceptance criteria, capture evidence, and validate user flows.
