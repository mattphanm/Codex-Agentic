...
```
.codex/specs/groups/<spec-group-id>/atomic/
...
node .codex/scripts/session-checkpoint.mjs complete-atomic-spec <atomic_spec_id>
```
...
Task({
  ...
  prompt: `Implement tasks 1-3 from TaskSpec at .codex/specs/groups/sg-logout-button/spec.md
...
Task({
  ...
  prompt: `Write tests for acceptance criteria AC1.1-AC2.3 from TaskSpec at .codex/specs/groups/sg-logout-button/spec.md
